    ...
    return (
        <div>
            ...
            {/* <footer class="text-gray-600 body-font">
                <div class="ft1 container py-24 flex items-center justify-center md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div class=" ft2 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        ...
                        <p class="mt-2 text-xl text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
                    </div>
                    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-gray-900 tracking-widest text-2xl mb-3">CATEGORIES</h2>
                            <nav class="list-none mb-10 text-2xl">
                                <li className='py-1 cursor-pointer'>
                                    <a class="text-gray-800  hover:bg-gray-200 ">First Link</a>
                                </li>
                                <li className='py-1 cursor-pointer'>
                ...
                <div class="bg-gray-400">
                    <div class="container mx-auto py-6 px-5 flex item-center flex-wrap flex-col sm:flex-row">
                        <p class="text-gray-600 text-xl text-center sm:text-left">© 2020 Tailblocks —
