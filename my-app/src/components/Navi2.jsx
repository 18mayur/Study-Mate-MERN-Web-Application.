...
const Navi2 = () => {
    ...
    return (
        <div>
            {/* <Router> */}
                <header className="bg-[#D9DAFF] shadow-2xl sticky top-0 backdrop-blur z-10 backdrop-opacity-20 backdrop-invert ">
                    <nav className=" h-[5.5rem] mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 text-xs" aria-label="Global">
                        <div className="flex lg:flex-1 relative left-[-75px]">
                            <a href="#" className="-m-1.5 p-1.5">
                                ...
                                <img className=" w-[230px] h-[80px]" src="images/logo3.jpg" alt="" />
                            </a>
                        </div>
                        ...
                        <Popover.Group className="hidden lg:flex lg:gap-x-20">
                            ...
                            <Link to="/jobs" onClick={scrollToTop} className=" relative top-[10px] text-xl font-bold leading-6 text-gray-900">
                                Job
                            </Link>

                            <Link to="/add" onClick={scrollToTop} className=" relative top-[10px] text-xl font-bold leading-6 text-gray-900">
                                Add Job
                            </Link>
                            {/* <Link to="/update" onClick={scrollToTop} className=" relative top-[10px] text-xl font-bold leading-6 text-gray-900">
                                Update Job
                            </Link> */}
                          
                            <Link to="/About2" onClick={scrollToTop} className=" relative top-[10px] text-xl font-bold leading-6 text-gray-900">
                                About
                            </Link>
