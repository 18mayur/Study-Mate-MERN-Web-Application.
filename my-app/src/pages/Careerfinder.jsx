    ...
    <div>
      ...
      <div class="relative pt-48 pb-12 bg-black xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56">
        ...
        <div class="absolute inset-0">
          <img class="object-cover w-full h-[45rem]" src="images/c4.jpg" alt="" />
        </div>
          ...
          <div class="px-6 ml-40 sm:px-8 lg:px-12 max-w-7xl">
            <div class="w-full lg:w-2/3 xl:w-4/5">
              <p class="mt-6 tracking-tighter text-white">
                ...
                <span class="font-serif italic font-normal text-8xl">Career Finder </span>
                <p className='font-serif  italic font-normal text-3xl leading-loose'>Find The Best Career Option To Related To Your Field.</p>
              </p>
            </div>
          </div>
        </div>
